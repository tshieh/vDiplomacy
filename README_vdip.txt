...
If you do not need a special vDiplomacy-feature I strongly recommend running the webdip-code instead of vDiplomacy. All variants _should_
work with the webdiplomacy code as well.
...
all needed SQL-tables and a generic Adminuser (without a password!!) automatically, or you can apply all necessary files on your own.
 1. install.sql (This will install the SQL-tables for webdip 1.00)
