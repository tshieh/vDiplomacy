...
"How do I play?" => "The gameplay is quite self explanatory, but if you're unsure about something read
	...
	to ask for help or clarification in <a href='/foro' class='light'>FORO</a>.",
...
print libHTML::pageTitle('Preguntas y respuestas m&aacute;s frecuentes, haz click en una pregunta para ampliar la respuesta.');
...
print '<div style="text-align:center; font-weight:bold"><strong>Secciones:</strong> '.implode(' - ', $sections).'</div>
