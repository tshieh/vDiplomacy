...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Backup_GameMessages` (
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Backup_Games` (
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Backup_Members` (
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Backup_MovesArchive` (
			`gameID` mediumint(8) unsigned NOT NULL,
			`turn` smallint(5) unsigned NOT NULL,
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Backup_Orders` (
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Backup_TerrStatus` (
			`id` int(10) unsigned NOT NULL DEFAULT '0',
			`terrID` smallint(5) unsigned NOT NULL,
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Backup_TerrStatusArchive` (
			`terrID` smallint(5) unsigned NOT NULL,
			`turn` smallint(5) unsigned NOT NULL,
			`standoff` enum('No','Yes') CHARACTER SET utf8 NOT NULL DEFAULT 'No',
			`gameID` mediumint(8) unsigned NOT NULL,
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Backup_Units` (
			`id` int(10) unsigned NOT NULL DEFAULT '0',
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_BannedNumbers` (
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_CivilDisorders` (
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_CoastalBorders` (
			`mapID` tinyint(3) unsigned NOT NULL,
			`fromTerrID` smallint(5) unsigned NOT NULL,
			`toTerrID` smallint(5) unsigned NOT NULL,
			`fleetsPass` enum('No','Yes') NOT NULL,
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_GameMessages` (
...
$sql[]="/*!40101 SET character_set_client = @saved_cs_client */;";
$sql[]="INSERT INTO `wD_Misc` VALUES ('Hits',0),('Version',100),('Panic',0),('Notice',0),('Maintenance',0),('LastProcessTime',0),('GamesNew',0),('GamesActive',0),('GamesFinished',0),('RankingPlayers',0),('TotalPlayers',0),('ErrorLogs',0),('GamesPaused',0),('GamesCrashed',0),('LastModAction',0),('OnlinePlayers',0),('GamesOpen',0),('ActivePlayers',0),('ForumThreads',0),('ThreadActiveThreshold',0),('ThreadAliveThreshold',0),('GameFeaturedThreshold',0);";
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_ModeratorNotes` (
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_MovesArchive` (
			`gameID` mediumint(8) unsigned NOT NULL,
			`turn` smallint(5) unsigned NOT NULL,
			`terrID` smallint(5) unsigned NOT NULL,
			`countryID` tinyint(3) unsigned NOT NULL,
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_PointsTransactions` (
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_TerrStatus` (
			`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
			`terrID` smallint(5) unsigned NOT NULL,
			`occupiedFromTerrID` smallint(5) unsigned DEFAULT NULL,
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_TerrStatusArchive` (
			`terrID` smallint(5) unsigned NOT NULL,
			`turn` smallint(5) unsigned NOT NULL,
			`standoff` enum('No','Yes') NOT NULL DEFAULT 'No',
			`gameID` mediumint(8) unsigned NOT NULL,
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_Territories` (
			`mapID` tinyint(3) unsigned NOT NULL,
...
$sql[]="/*!40101 SET @saved_cs_client = @@character_set_client */;";
$sql[]="/*!40101 SET character_set_client = utf8 */;";
$sql[]="CREATE TABLE `wD_UnitDestroyIndex` (
			`mapID` tinyint(3) unsigned NOT NULL,
			`countryID` tinyint(3) unsigned NOT NULL,
			`terrID` smallint(5) unsigned NOT NULL,
			`unitType` enum('Army','Fleet') NOT NULL,
...
$sql[]="ALTER TABLE `wD_Backup_Games` ADD `minRating` SMALLINT( 5 ) UNSIGNED NOT NULL DEFAULT '0';";
...
// Webdip 1.35
$sql[]="CREATE TABLE `wD_VariantData` (
	`variantID` tinyint(3) unsigned NOT NULL,
...
$sql[]="INSERT INTO `wD_Users` (`username`, `email`, `points`, `password`, `type`) VALUES
			('Admin', 'admin@localhost', 1000, UNHEX('".libAuth::pass_Hash('')."'), 'User,Moderator,Admin');";
...
// Run the gamemaster for the 1st time...
header('refresh: 0; url=gamemaster.php');
