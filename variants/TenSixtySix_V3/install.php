<?php
// This is file installs the map data for the TenSixtySix_V3 variant
...
$territoryRawData=array(
	...
	array('Warwick', 'Land', 'Yes', 1, 361, 583, 180, 296),
	...
	array('East Anglia', 'Coast', 'No', 1, 418, 645, 223, 303),
...
$bordersRawData=array(
	...
	array('Lincolnshire','Warwick','No','Yes'),
	array('Lincolnshire','East Anglia','Yes','Yes'),
	array('Lincolnshire','Southwest North Sea','Yes','No'),
	array('Lincolnshire','Northwest North Sea','Yes','No'),
	array('York','The Dales','No','Yes'),
	array('York','Warwick','No','Yes'),
	array('York','Hadrian s Wall','No','Yes'),
	array('York','Northwest North Sea','Yes','No'),
	array('The Dales','Warwick','No','Yes'),
	array('The Dales','Hadrian s Wall','No','Yes'),
	array('The Dales','Gwynedd and Lakes District','No','Yes'),
	array('Warwick','Gwynedd and Lakes District','No','Yes'),
	array('Warwick','Wales','No','Yes'),
	array('Warwick','East Anglia','No','Yes'),
	array('Warwick','London','No','Yes'),
	array('Warwick','Oxford','No','Yes'),
	...
	array('Northeast North Sea','Denmark','Yes','No'),
